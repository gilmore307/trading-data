...
- `05_bundle_option_expression` — SQL-only ThetaData option-chain snapshot table for OptionExpressionModel; still scheduled for contract-level entry/exit snapshot revision.
