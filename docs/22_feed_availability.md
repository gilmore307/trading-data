...
| Official calendar discovery | Nasdaq earnings calendar shells, Nasdaq/S&P DJI index announcements, NYSE/Nasdaq exchange calendar artifacts. | Public official or reviewed local artifacts; live calls require manager controls. | Active artifact route for `calendar_observation`; no direct Layer 10 event-pool admission. |
