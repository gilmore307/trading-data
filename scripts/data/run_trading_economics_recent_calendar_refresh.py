...
def build_recent_calendar_task_key(
    *,
    ...
    """Build a bounded recent-calendar task key with provider controls."""
...
def build_plan_receipt(*, task_key: dict[str, Any], run_id: str) -> dict[str, Any]:
    return {
        ...
        "boundary_note": "Plan-only receipt. Add --execute-live-fetch to perform the bounded visible-page fetch.",
    }
