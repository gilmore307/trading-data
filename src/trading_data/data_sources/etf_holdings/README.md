...
`etf_holdings` is the official issuer-holdings interface for ETF constituent and portfolio-weight snapshots.
...
- `etf_ticker` — required.
- `issuer` — required until the mapping table is registered.
