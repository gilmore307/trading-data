...
- `trading_data.storage.*` owns low-level persistence adapters and receipt-safe storage metadata.
- Data bundles own the semantic table contract they write: table name, columns, natural key, and row normalization.
