...
from trading_data.data_sources.calendar_discovery.pipeline import run


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="python -m trading_data.data_sources.calendar_discovery")
