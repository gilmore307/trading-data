...
LAYER_CONTRACTS: tuple[LayerDataContract, ...] = (
    ...
    LayerDataContract(
        ...
        owns_dedicated_data_surface=True,
        source_packages=("data_source.m10_event_risk_governor_data_acquisition",),
        feature_packages=("data_feature.m10_event_risk_governor_feature_generation",),
        cli_commands=("trading-data-m10-event-risk-governor-data-acquisition", "trading-data-m10-event-risk-governor-feature-generation"),
        test_paths=(
            "tests/data_source/test_numbered_data_sources.py",
