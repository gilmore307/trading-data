...
from trading_data.source_availability.http import HttpClient
from trading_data.source_availability.report import report_payload, write_report
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="python -m trading_data.source_interfaces")
