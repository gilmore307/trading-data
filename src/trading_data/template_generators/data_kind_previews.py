...
INTERVAL_START = field("fld_MKT002")
...
EVENT_FACTOR_AS_OF = field("fld_EVT031")
...
GDELT_ARTICLE_SEEN_AT = field("fld_GDLT002")
...
TRADING_ECONOMICS_EVENT_TIME = field("fld_EVT013")
...
STOCK_ETF_AVAILABLE_TIME = field("fld_STKEX011")
...
CSV_TEMPLATES: tuple[CsvTemplate, ...] = (
    csv_template(
        ...
        [GDELT_ARTICLE_ID, GDELT_ARTICLE_SEEN_AT, GDELT_SOURCE_DOMAIN, GDELT_ARTICLE_URL, GDELT_ARTICLE_LANGUAGE, GDELT_SOURCE_COUNTRY, GDELT_ARTICLE_TITLE, SOURCE_THEME_TAGS, GDELT_PERSONS, GDELT_ORGANIZATIONS, GDELT_LOCATIONS, GDELT_TONE, GDELT_SHARING_IMAGE, EVENT_IMPACT_SCOPE, GDELT_SOURCE_TYPE],
        ["20260427123000-1", "2026-04-27T08:30:00-04:00", "example.com", "https://example.com/politics-economy-tech", "", "", "", "ECON_STOCKMARKET;TAX_FNCACT", "", "Federal Reserve", "US#United States#US", -1.2, "https://example.com/image.jpg", "market;sector;industry;theme", "gdelt_gkg_article"],
    ),
    csv_template(
        "trading_economics/trading_economics_calendar_event.preview.csv",
        [TRADING_ECONOMICS_EVENT_TIME, TRADING_ECONOMICS_COUNTRY, TRADING_ECONOMICS_EVENT, SOURCE_EVENT_TYPE, TRADING_ECONOMICS_REFERENCE, TRADING_ECONOMICS_ACTUAL, TRADING_ECONOMICS_PREVIOUS, TRADING_ECONOMICS_CONSENSUS, TRADING_ECONOMICS_FORECAST, TRADING_ECONOMICS_REVISED, TRADING_ECONOMICS_IMPORTANCE, TRADING_ECONOMICS_SYMBOL, TRADING_ECONOMICS_SOURCE_URL],
    ...
    csv_template(
        ...
        [STOCK_ETF_EXPOSURE_AS_OF_DATE, STOCK_ETF_EXPOSURE_SYMBOL, STOCK_ETF_EXPOSED_ETFS, STOCK_ETF_TOP_EXPOSURE_ETF, STOCK_ETF_TOTAL_EXPOSURE_SCORE, STOCK_ETF_WEIGHTED_SECTOR_SCORE, STOCK_ETF_WEIGHTED_THEME_SCORE, EXPOSURE_TAGS, STOCK_ETF_SOURCE_ETF_COUNT, STOCK_ETF_SOURCE_SNAPSHOT_REFS, STOCK_ETF_AVAILABLE_TIME],
    ...
    csv_template(
        ...
        [INSTRUMENT_SYMBOL, DATA_TIMEFRAME, DATA_TIMESTAMP, OPEN_PRICE, HIGH_PRICE, LOW_PRICE, CLOSE_PRICE, VOLUME, VWAP, TRADE_COUNT],
    ...
    csv_template(
        ...
        [INSTRUMENT_SYMBOL, DATA_TIMEFRAME, INTERVAL_START, TRADE_COUNT, QUOTE_COUNT, VOLUME, VWAP, OPEN_PRICE, HIGH_PRICE, LOW_PRICE, CLOSE_PRICE, QUOTE_AVG_BID, QUOTE_AVG_ASK, QUOTE_AVG_MID, QUOTE_AVG_SPREAD, QUOTE_LAST_BID, QUOTE_LAST_ASK, QUOTE_LAST_MID, VWAP_MINUS_QUOTE_AVG_MID],
    ...
    csv_template(
        ...
        [EVENT_ID, EVENT_SYMBOL, EVENT_TIME, EVENT_EFFECTIVE_TIME, EVENT_TYPE, EVENT_SOURCE_TYPE, EVENT_TITLE, EVENT_SUMMARY, ABNORMAL_ACTIVITY_TYPE, ABNORMAL_ACTIVITY_EVIDENCE_WINDOW, RETURN_ZSCORE, VOLUME_ZSCORE, RELATIVE_STRENGTH_ZSCORE, GAP_PCT, LIQUIDITY_SPREAD_ZSCORE, EQUITY_ABNORMAL_ACTIVITY_SOURCE_REFS, EVENT_TAXONOMY_CONTEXT],
        ["eq_abn_N7K4Q2MX", "NVDA", "2026-04-24T09:35:00-04:00", "2026-04-24T09:36:00-04:00", "equity_abnormal_activity_event", "alpaca_equity_market_data", "NVDA abnormal opening move with volume expansion", "NVDA showed abnormal return and volume versus recent same-time windows and sector benchmark.", "return_zscore;volume_spike;sector_relative_move", '{"timeframe":"5Min","window_start":"2026-04-24T09:30:00-04:00","window_end":"2026-04-24T09:35:00-04:00","lookback_days":20}', 3.1, 4.8, 2.2, 1.4, 0.7, "alpaca_bars:NVDA:2026-04-24T09:30;alpaca_liquidity:NVDA:2026-04-24T09:30;sector:SMH", '{"benchmark":"SMH","detector":"equity_abnormal_activity_v0"}'],
    ),
    csv_template(
