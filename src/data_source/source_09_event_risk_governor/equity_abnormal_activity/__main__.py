...
def _run(task_key: dict, *, run_id: str):
    module = importlib.import_module(
        "data_source.source_09_event_risk_governor.equity_abnormal_activity.pipeline"
    )
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m data_source.source_09_event_risk_governor.equity_abnormal_activity"
    )
