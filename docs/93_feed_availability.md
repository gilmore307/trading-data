...
| Trading Economics visible pages | Macro calendar/value rows visible on web pages. | No API key for accepted route; no download/WAF/captcha bypass. | Accepted macro model-input route. |
