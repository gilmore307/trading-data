...
| GDELT BigQuery | `gdelt/` | `gdelt_article` | Primary broad news/event discovery source for U.S. and U.S.-market political, economic, technology, geopolitical, sector, industry, theme, and market-impact event candidates; queries pre-filter in BigQuery. |
