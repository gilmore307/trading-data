...
- `from_feed_artifacts.py` owns offline materialization from saved feed artifacts into `m01_market_regime_data_acquisition` before deterministic feature generation.
