...
INTERFACES: dict[str, DataKindInterface] = {
    ...
    "option_contract": DataKindInterface(
        "option_contract", "thetadata", "thetadata_option_selection_snapshot", "GET /v3/option/list/contracts/quote",
    ...
    "option_trade": DataKindInterface(
        "option_trade", "thetadata", "thetadata_option_event_timeline", "GET /v3/option/history/trade",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_quote": DataKindInterface(
        "option_quote", "thetadata", "thetadata_option_event_timeline", "GET /v3/option/history/quote",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_nbbo": DataKindInterface(
        "option_nbbo", "thetadata", "thetadata_option_event_timeline", "GET /v3/option/history/trade_quote",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_ohlc": DataKindInterface(
        "option_ohlc", "thetadata", "thetadata_option_primary_tracking", "GET /v3/option/history/ohlc",
    ...
    "option_eod": DataKindInterface(
        "option_eod", "thetadata", "thetadata_option_primary_tracking", "GET /v3/option/history/eod",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_open_interest": DataKindInterface(
        "option_open_interest", "thetadata", "thetadata_option_selection_snapshot", "GET /v3/option/history/open_interest",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_implied_volatility": DataKindInterface(
        "option_implied_volatility", "thetadata", "thetadata_option_selection_snapshot", "GET /v3/option/snapshot/greeks/implied_volatility",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_greeks_first_order": DataKindInterface(
        "option_greeks_first_order", "thetadata", "thetadata_option_selection_snapshot", "GET /v3/option/snapshot/greeks/first_order",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_greeks_second_order": DataKindInterface(
        "option_greeks_second_order", "thetadata", "thetadata_option_selection_snapshot", "GET /v3/option/history/greeks/second_order",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_greeks_third_order": DataKindInterface(
        "option_greeks_third_order", "thetadata", "thetadata_option_selection_snapshot", "GET /v3/option/history/greeks/third_order",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_trade_greeks": DataKindInterface(
        "option_trade_greeks", "thetadata", "thetadata_option_event_timeline", "GET /v3/option/history/trade_greeks/first_order",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_snapshot": DataKindInterface(
        "option_snapshot", "thetadata", "thetadata_option_selection_snapshot", "GET /v3/option/snapshot/quote",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    # SEC EDGAR open APIs.
