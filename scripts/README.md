...
| 4 Event Overlay | `trading-data-source-04-event-overlay` |
...
| 8 Option Expression | `trading-data-source-05-option-expression`, `trading-data-source-06-position-execution`, and ThetaData option feed CLIs `09`-`11`. |
