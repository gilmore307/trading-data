#!/usr/bin/env python3
"""Refresh the shared equity total symbol pool from a TradingView screener snapshot."""
...
def main() -> int:
    ...
    receipt = {
        ...
        "boundary_note": "This refresh performs one bounded TradingView screener snapshot and builds the shared calendar symbol pool; it performs no broker/account/model activation.",
    }
