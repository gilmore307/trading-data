"""SQL wrapper for m03_event_state_feature_generation production."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--source-table", default="model_03_event_state_data_acquisition")
    parser.add_argument("--target-schema", default="trading_data")
    parser.add_argument("--target-table", default="model_03_event_state_feature_generation")
    parser.add_argument("--source-start")
    parser.add_argument("--source-end")
    parser.add_argument("--run-id", default="model_03_event_state_feature_generation_sql")
