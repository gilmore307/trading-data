...
def _table_ddl(table: str, qualified_table: str) -> str | None:
    ...
    if table == "source_08_event_risk_governor":
        return _source_08_event_risk_governor_ddl(qualified_table)
    return None
...
def _source_08_event_risk_governor_ddl(qualified_table: str) -> str:
    return f"""
    CREATE TABLE IF NOT EXISTS {qualified_table} (
