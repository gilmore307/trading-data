    ...
    *,
    ...
    cursor.execute(
        ...
        CREATE TABLE IF NOT EXISTS {qualified_table} (
          ...
          "rotation_pair_id" TEXT NOT NULL,
          "rotation_pair_type" TEXT NOT NULL,
          "feature_bar_grain" TEXT NOT NULL,
          "feature_payload_json" JSONB NOT NULL DEFAULT '{{}}'::jsonb,
          PRIMARY KEY ("snapshot_time", "candidate_symbol", "comparison_symbol", "rotation_pair_id")
        )
        """
    )
    ...
    insert_sql = f"""
        ...
        ON CONFLICT ("snapshot_time", "candidate_symbol", "comparison_symbol", "rotation_pair_id") DO UPDATE SET
          "candidate_type" = EXCLUDED."candidate_type",
          "rotation_pair_type" = EXCLUDED."rotation_pair_type",
          "feature_bar_grain" = EXCLUDED."feature_bar_grain",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--source-table", default="model_01_market_regime_data_acquisition")
    parser.add_argument("--target-schema", default="trading_data")
    parser.add_argument("--target-table", default="model_02_sector_context_feature_generation")
