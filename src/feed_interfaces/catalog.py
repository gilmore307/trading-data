...
INTERFACES: dict[str, DataKindInterface] = {
    ...
    "gdelt_article": DataKindInterface(
        "gdelt_article", "gdelt", "05_feed_gdelt_news", "BigQuery gdelt-bq.gdeltv2.gkg_partitioned",
        "https://www.gdeltproject.org/data.html", "service-account", {"query_terms": ["inflation", "semiconductor"], "lookback_days": 1, "max_rows": 5},
        ("Primary broad political/economic/technology news feed evidence; downstream event clustering chooses canonical events.",),
    ),
    # OKX public market data.
    "crypto_bar": DataKindInterface(
        "crypto_bar", "okx", "04_feed_okx_crypto_market_data", "GET /api/v5/market/candles",
    ...
    "crypto_trade": DataKindInterface(
        "crypto_trade", "okx", "04_feed_okx_crypto_market_data", "GET /api/v5/market/trades",
    ...
    "crypto_quote": DataKindInterface(
        "crypto_quote", "okx", "04_feed_okx_crypto_market_data", "GET /api/v5/market/ticker",
    ...
    "crypto_order_book": DataKindInterface(
        "crypto_order_book", "okx", "04_feed_okx_crypto_market_data", "GET /api/v5/market/books",
    ...
    "option_contract": DataKindInterface(
        "option_contract", "thetadata", "09_feed_thetadata_option_selection_snapshot", "GET /v3/option/list/contracts/quote",
    ...
    "option_trade": DataKindInterface(
        "option_trade", "thetadata", "11_feed_thetadata_option_event_timeline", "GET /v3/option/history/trade",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_quote": DataKindInterface(
        "option_quote", "thetadata", "11_feed_thetadata_option_event_timeline", "GET /v3/option/history/quote",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_nbbo": DataKindInterface(
        "option_nbbo", "thetadata", "11_feed_thetadata_option_event_timeline", "GET /v3/option/history/trade_quote",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_ohlc": DataKindInterface(
        "option_ohlc", "thetadata", "10_feed_thetadata_option_primary_tracking", "GET /v3/option/history/ohlc",
    ...
    "option_eod": DataKindInterface(
        "option_eod", "thetadata", "10_feed_thetadata_option_primary_tracking", "GET /v3/option/history/eod",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_open_interest": DataKindInterface(
        "option_open_interest", "thetadata", "09_feed_thetadata_option_selection_snapshot", "GET /v3/option/history/open_interest",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    ...
    "option_greeks_second_order": DataKindInterface(
        "option_greeks_second_order", "thetadata", "09_feed_thetadata_option_selection_snapshot", "GET /v3/option/history/greeks/second_order",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_greeks_third_order": DataKindInterface(
        "option_greeks_third_order", "thetadata", "09_feed_thetadata_option_selection_snapshot", "GET /v3/option/history/greeks/third_order",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    "option_trade_greeks": DataKindInterface(
        "option_trade_greeks", "thetadata", "11_feed_thetadata_option_event_timeline", "GET /v3/option/history/trade_greeks/first_order",
        "https://http-docs.thetadata.us/", "local-terminal", {"symbol": "AAPL"},
    ),
    ...
    "sec_submission": DataKindInterface(
        "sec_submission", "sec_edgar", "08_feed_sec_company_financials", "GET submissions/CIK##########.json",
    ...
    "sec_company_fact": DataKindInterface(
        "sec_company_fact", "sec_edgar", "08_feed_sec_company_financials", "GET api/xbrl/companyfacts/CIK##########.json",
        "https://www.sec.gov/search-filings/edgar-application-programming-interfaces", "open/user-agent", {"cik": "0000320193"},
    ),
    "sec_company_concept": DataKindInterface(
        "sec_company_concept", "sec_edgar", "08_feed_sec_company_financials", "GET api/xbrl/companyconcept/CIK##########/us-gaap/Assets.json",
    ...
    "sec_xbrl_frame": DataKindInterface(
        "sec_xbrl_frame", "sec_edgar", "08_feed_sec_company_financials", "GET api/xbrl/frames/us-gaap/Assets/USD/CY2023Q4I.json",
    ...
    "trading_economics_calendar_event": DataKindInterface(
        "trading_economics_calendar_event", "trading_economics", "07_feed_trading_economics_calendar_web", "visible macro calendar web page",
...
def list_interfaces(feed: str | None = None) -> list[DataKindInterface]:
    values = sorted(INTERFACES.values(), key=lambda item: (item.feed, item.data_kind))
    if feed:
        values = [item for item in values if item.feed == feed]
    return values
