...
- `m06_residual_event_governance_data_acquisition` — EventRiskGovernor source package; writes the SQL table `model_06_residual_event_governance_data_acquisition`, one row per event, with details behind references.
