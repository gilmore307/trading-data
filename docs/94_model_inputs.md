...
Source: `src/data_source/source_08_event_risk_governor/equity_abnormal_activity/`

Config: `src/data_source/source_08_event_risk_governor/equity_abnormal_activity/config.json`
...
- `source_05_option_expression` is source-number 05 for option-expression input; it is not model Layer 4 `AlphaConfidenceModel` acquisition.
