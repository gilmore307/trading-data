...
Source: `src/data_source/source_09_event_risk_governor/equity_abnormal_activity/`

Config: `src/data_source/source_09_event_risk_governor/equity_abnormal_activity/config.json`
...
- Price-action tokens are detector evidence for Layer 9 event-risk governance; they are not a separate model layer, trading action, or production-calibrated label without reviewed historical evidence.
