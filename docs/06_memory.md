...
- OKX is the first registered crypto provider config surface. Use `trading-main` config aliases `okx/api-key`, `okx/secret-key`, and `okx/passphrase`; do not copy secret values into this repo.
