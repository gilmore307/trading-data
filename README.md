...
- readiness signals under `trading-storage/1_market_regime/1_permanent/8_signals/`
...
- signal output has been repathed to `trading-storage/1_market_regime/1_permanent/8_signals/`
