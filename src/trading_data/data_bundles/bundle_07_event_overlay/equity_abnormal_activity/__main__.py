...
def _run(task_key: dict, *, run_id: str):
    module = importlib.import_module(
        "trading_data.data_bundles.bundle_07_event_overlay.equity_abnormal_activity.pipeline"
    )
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m trading_data.data_bundles.bundle_07_event_overlay.equity_abnormal_activity"
    )
