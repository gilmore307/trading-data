# Layer 08 — Trading Guidance / Option Expression Data Boundary

<!-- ACTIVE_LAYER_REVISION -->
Status: active architecture revision. Layer 8 owns base trading guidance; `trading-data` owns option-expression source inputs used by the option-expression subset of Layer 8.

Current feature/source names are `source_05_option_expression`, `feature_08_option_expression`, and `source_06_position_execution`. The source numbers are accepted data-source identifiers; the conceptual model boundary is Layer 8.
<!-- /ACTIVE_LAYER_REVISION -->
