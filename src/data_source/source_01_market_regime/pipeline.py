"""Manager-facing MarketRegimeModel ETF bar source."""
...
SQL_FIELDS = FIELDS
MARKET_REGIME_ETF_UNIVERSE_PATH = Path("/root/projects/trading-storage/main/shared/layer_1_2_market_context_etf_universe.csv")
DEFAULT_LIMIT = 1000
...
class MarketRegimeInputsError(ValueError):
    """Raised for invalid MarketRegimeModel input source tasks."""
