...
- `06_layer_05_alpha_confidence.md` — Layer 5 no-new-source boundary.
- `07_layer_06_position_projection.md` — Layer 6 no-new-source boundary.
- `08_layer_07_underlying_action.md` — Layer 7 no-new-source boundary.
