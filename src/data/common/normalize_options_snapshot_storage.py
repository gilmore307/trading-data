...
def main() -> None:
    ...
    parser.add_argument("--only", nargs="*", default=None, help="relative options_snapshots.jsonl paths under trading-storage/2_market_tape/1_data/5_options_snapshots/")
