# 05_source_gdelt_news bundle

`05_source_gdelt_news` acquires pre-filtered source article evidence from GDELT BigQuery. It is the primary broad news source for U.S. and U.S.-market political, economic, war/geopolitical, and technology event discovery.

Run:

```bash
PYTHONPATH=src:/root/projects/trading-main/src python3 -m data_sources.05_source_gdelt_news task.json --run-id 05_source_gdelt_news_run_<id>
```
