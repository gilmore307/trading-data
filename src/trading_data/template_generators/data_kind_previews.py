...
TRADING_ECONOMICS_EVENT_TIME_ET = field("fld_TEC001")
...
TRADING_ECONOMICS_SYMBOL = field("fld_TEC012")
TRADING_ECONOMICS_SOURCE_URL = field("fld_TEC013")
...
CSV_TEMPLATES: tuple[CsvTemplate, ...] = (
    ...
    csv_template(
        ...
        [ETF_TICKER, ETF_ISSUER, ETF_HOLDINGS_AS_OF_DATE, ETF_HOLDING_TICKER, ETF_HOLDING_NAME, ETF_HOLDING_WEIGHT, ETF_HOLDING_SHARES, ETF_HOLDING_MARKET_VALUE, ETF_HOLDING_CUSIP, ETF_HOLDING_SEDOL, ETF_HOLDING_ASSET_CLASS, ETF_HOLDING_SECTOR, ETF_HOLDING_SOURCE_URL],
