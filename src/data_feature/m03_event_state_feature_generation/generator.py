"""Deterministic feature builder for M03 EventState source rows."""
...
def generate_rows(rows: Iterable[Mapping[str, Any]], *, run_id: str = "model_03_event_state_feature_generation") -> list[dict[str, Any]]:
    ...
    for row in rows:
        ...
        output.append(
            {
                "run_id": run_id,
                "source_run_ref": row.get("source_run_ref") or row.get("run_id") or "model_03_event_state_data_acquisition",
