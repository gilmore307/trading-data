...
- keep focused industry/theme ETFs out of Layer 2 unless a separate reviewed proxy/theme layer is accepted, while preserving the `BKCH` crypto context-anchor exception;
