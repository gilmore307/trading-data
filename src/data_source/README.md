...
- `source_08_event_risk_governor` — SQL-only EventRiskGovernor overview table; one row per event, with details behind references.
- `source_08_event_risk_governor/equity_abnormal_activity` — nested event-risk detector for equity/ETF abnormal activity evidence rows.
