...
LAYER_CONTRACTS: tuple[LayerDataContract, ...] = (
    LayerDataContract(
        ...
        doc_path="docs/02_layer_01_market_regime.md",
    ...
    LayerDataContract(
        ...
        doc_path="docs/03_layer_02_sector_context.md",
        owns_dedicated_data_surface=True,
        source_packages=("data_source.source_02_target_candidate_holdings",),
        feature_packages=("data_feature.feature_02_sector_context",),
        cli_commands=("trading-data-source-02-target-candidate-holdings", "trading-data-feature-02-sector-context"),
        test_paths=(
    ...
    LayerDataContract(
        ...
        doc_path="docs/04_layer_03_target_state_vector.md",
        owns_dedicated_data_surface=True,
        source_packages=("data_source.source_03_target_state",),
        feature_packages=("data_feature.feature_03_target_state_vector",),
        cli_commands=("trading-data-source-03-target-state", "trading-data-feature-03-target-state-vector"),
        test_paths=(
