...
| Macro / political / war / geopolitical news regimes | GDELT topic/entity/event evidence plus official action archives where available | GDELT monitoring plus official government, sanctions, defense, diplomatic, and high-quality news sources where available | Reuters/AP/Bloomberg/WSJ/FT style sources and official refs as evidence | GDELT is a broad event-regime/news-topic source, not a single-stock headline source; promotion requires reviewed topic-frequency/regime evidence and decay rules |
