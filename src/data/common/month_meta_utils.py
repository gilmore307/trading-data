...
DATASET_KEY_BY_FILENAME = {
    ...
    'quotes.jsonl': 'quotes',
    'trades.jsonl': 'trades',
    'quotes_1min.jsonl': 'quotes_1min',
    'trades_1min.jsonl': 'trades_1min',
...
LEGACY_META_BY_FILENAME = {
    ...
    'quotes_1min.jsonl': 'quotes_1min.meta.json',
    'trades_1min.jsonl': 'trades_1min.meta.json',
