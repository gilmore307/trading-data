# 07_event_overlay_model_inputs/equity_abnormal_activity

Derived event detector inside the `07_event_overlay_model_inputs` EventOverlayModel layer. This is not a standalone manager-facing numbered data bundle.
